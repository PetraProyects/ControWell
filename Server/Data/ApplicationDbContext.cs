...
namespace ControWell.Server.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<FormatoCarga> FormatoCargas { get; set; }
        public DbSet<FormatoDescargueNaf> FormatoDescargueNafs { get; set; }
        public DbSet<PruebaPozo> PruebaPozos { get; set; }        
    }
}

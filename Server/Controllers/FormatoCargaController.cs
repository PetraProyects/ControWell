...
namespace ControWell.Server.Controllers
{
    ...
    public class FormatoCargaController : ControllerBase
    {
        ...
        public FormatoCargaController(ApplicationDbContext context)
        {
		...
		[HttpGet]
		[Route("formatoslo028/{filtro}")]
		public IActionResult ExportExcel(string filtro)
        {

            try
            {
                using (var workbook = new XLWorkbook(@"C:\ControWell\Client\wwwroot\FormatoCarrotanquesCargados.xlsx"))
                {
